...
// })
var sql = "CREATE TABLE if not exists users (id INT(30), UserName VARCHAR(255), PassWord VARCHAR(255), NickName VARCHAR(255), Signature VARCHAR(255), HeadIcon VARCHAR(255), Sex INT(1), Age INT(3), RoleId INT(6), CreateTime TIMESTAMP(6))";
